...
const ProductDetail = ({ product }) => {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-10">
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-sm border p-5 sm:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Main Image */}
            <div className="w-full h-[400px] sm:h-[500px] bg-gray-50 rounded-xl overflow-hidden flex items-center justify-center">
              <img
                src={selectedImage}
                alt={product.images.alt_text}
          ...
          <div className="flex flex-col">
            ...
            <div>
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <span className="text-lg text-gray-500 line-through">
                  ₹{product.pricing.list_price.toLocaleString("en-IN")}
                </span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-7">
              ...
              <button
                ...
                className="flex-1 bg-yellow-500 hover:bg-yellow-600 disabled:bg-gray-300 text-white font-bold py-3.5 rounded-xl transition-all duration-300"
              >
                Add to Cart
              </button>
              ...
              <button
                ...
                className="flex-1 bg-orange-600 hover:bg-orange-700 disabled:bg-gray-300 text-white font-bold py-3.5 rounded-xl transition-all duration-300"
              >
                Buy Now
              </button>
      ...
      <div className="max-w-7xl mx-auto mt-6 bg-white rounded-2xl shadow-sm border p-5 sm:p-8">
